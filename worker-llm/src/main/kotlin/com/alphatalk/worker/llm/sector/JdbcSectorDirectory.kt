...
class JdbcSectorDirectory(
    ...
    override fun allSectors(): List<SectorInfo> = tolerant("allSectors", emptyList()) {
    ...
    override fun sectorName(sectorCode: String): String? = tolerant("sectorName", null) {
        jdbc.query(
    ...
    override fun memberCodes(sectorCode: String): List<String> = tolerant("memberCodes", emptyList()) {
        jdbc.query(
    ...
    override fun stockName(stockCode: String): String? = tolerant("stockName", null) {
        jdbc.query(
    ...
    override fun sectorOf(stockCode: String): String? = tolerant("sectorOf", null) {
        jdbc.query(
    ...
    private fun <T> tolerant(operation: String, fallback: T, query: () -> T): T = runCatching(query)
        .onFailure { log.warn("sector directory unavailable ({}): {}", operation, it.message) }
